...
You can submit all your proposals until 23:59 on **Sunday, July 26, 2020**.
...
As this year there will just be a single track of talks and given that there are specific events for Data Science and ML, we decided to focus on topics that have less opportunities to be shown and that are also relevant for the Python community. We’d like to propose the following topics:
